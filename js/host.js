var url = "http://" + target + "/monitor/host";
...
layui.use(['form', 'layedit', 'laydate'], function () {
  ...
  form.on('submit(demo1)', function (data) {
    var userInfo = {
      ...
      "ip": data.field.IP,
      "longitude": data.field.longitude||0,
      "dimension": data.field.dimension||0
    };
    fetch(url, {
      method: 'POST',
      headers: {
  ...
  layui.use('table', function () {
    ...
    table.render({
      ...
      <input style="width: 150px; height:31px;" type="text" id="select_orderId" name="select_orderId"  placeholder="请输入设备名称" autocomplete="off" class="layui-input">
      </div>
      <div class="" style="float: left; position: relative;">
